    ...
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.sent(); // responsible for connecting to the wallet
...
function fund() {
    return __awaiter(this, void 0, void 0, function () {
        var ethAmount, addresses, connectedAccount, currentChain, request, hash;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                ...
                case 2:
                    ...
                    return [4 /*yield*/, publicClient.simulateContract({
                            ...
                            chain: currentChain,
                            value: (0, viem_1.parseEther)(ethAmount), // turns 1 => 100000000
                        })];
                case 3:
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    if (!publicClient) return [3 /*break*/, 2];
                    return [4 /*yield*/, publicClient.getBalance({ address: constants_ts_1.contractAddress })];
                case 1:
                    balance = _a.sent();
                    console.log((0, viem_1.formatEther)(balance)); // is the opposite of parseEther. Turns 100000000 => 1
                    _a.label = 2;
...
function withdraw() {
    return __awaiter(this, void 0, void 0, function () {
        var addresses, connectedAccount, currentChain, request, hash;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
